...
const LoginForm = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className='w-full md:w-1/2 bg-gray-50 p-4 md:p-8 rounded-l-3xl md:rounded-l-none md:rounded-l-3xl shadow-lg'>
      <a href='/'>
      ...
      <h1 className='text-2xl md:text-3xl my-4 md:my-6 text-center'>Welcome Back</h1>
      <h2 className='text-lg md:text-xl font-light my-4 md:my-6 text-center'>Login with email</h2>
      ...
      <a href='/' className='underline block mb-4 text-center hover:text-[#37af65]'>
        Forgot Password
      </a>
      ...
      <div className='flex flex-col md:flex-row gap-2 mt-4 md:mt-5 md:ml-0 md:ml-16'>
        ...
        <a href='/signup' className='underline block mb-4 text-center md:text-left hover:text-[#37af65]'>
          Signup
        </a>
      </div>
    </form>
