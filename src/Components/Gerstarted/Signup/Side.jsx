...
const Side = () => {
  ...
  return (
    <div className="bg-green-900 text-white w-full lg:w-1/2 p-6 lg:p-10 rounded-b-3xl lg:rounded-l-3xl lg:rounded-r-none shadow-2xl flex flex-col items-center lg:items-start">
      <div className="mb-10">
        <a href="/">
