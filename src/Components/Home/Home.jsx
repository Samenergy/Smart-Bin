...
const Hero = () => {
  return (
    <div className="hero-container" id="b-image">
      <div className="content-wrapper px-4 sm:px-6 lg:px-8">
        <div className="content mx-auto max-w-2xl py-12 sm:py-24 lg:py-32">
          <div className="text-content text-left sm:text-left lg:-ml-40">
            <h1 className="welcome-text mt-6 text-lg sm:text-xl md:text-2xl lg:text-xl xl:text-xl leading-8 text-gray-500 font-semibold">
              WELCOME TO Smart Bin
            </h1>
            <h1 className="main-heading text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-5xl font-bold tracking-tight text-gray-50">
              Next Generation
            </h1>
            <h1 className="main-heading text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-5xl font-bold tracking-tight text-gray-50">
              Smart <span className="text-[#37af65]">Waste</span> Management
            </h1>
            <p className="description mt-4 text-base sm:text-lg md:text-xl lg:text-2xl xl:text-xl leading-8 text-gray-400">
