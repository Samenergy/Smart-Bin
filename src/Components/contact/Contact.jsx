      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 items-center gap-16 p-8 mx-4 md:mx-20 max-w-4xl bg-white text-[#333]">
        ...
        <form className="space-y-4">
          <input
            type="text"
            placeholder="Name"
            className="w-full rounded-md py-2.5 px-4 border text-sm outline-[#37af65]"
          />
          <input
            type="email"
            placeholder="Email"
          ...
          <textarea
            placeholder="Message"
            rows="6"
            className="w-full rounded-md px-4 border text-sm pt-2.5 outline-[#37af65]"
          ></textarea>
          <button
            type="button"
            className="text-white bg-[#37af65] hover:bg-green-600 font-semibold rounded-md text-sm px-4 py-2.5 w-full"
          >
            Send
          </button>
        </form>
